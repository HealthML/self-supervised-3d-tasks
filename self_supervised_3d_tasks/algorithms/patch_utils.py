...
PERMUTATION_PATH = Path(__file__).parent.parent / "permutations" / "permutations_100_max.bin"
...
def permutate_and_concat_image_patches(patch_embeddings, perms):
    ...
    def permutate_patch(perm):
        ...
        concat_tensor = tf.reshape(concat_tensor, shape=[-1, h, w, perm_len * c])
...
def permutate_and_concat_batch_patches(batch_patch_embeddings, perms, batch_size):
